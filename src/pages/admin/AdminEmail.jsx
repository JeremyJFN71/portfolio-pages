...
export default function AdminEmail() {
   ...
   const deleteAll = async () => {
      ...
      const { data } = await deleteAllEmails();
   ...
   return (
      <>
         <h1 className="fw-bold font-primary mb-3" data-aos="fade-right">
            EMAIL
         </h1>
         {isError ? (
            <Error />
            ...
            <>
               <div
                  className="d-flex mb-4 justify-content-between align-items-center px-3 py-2 tertiary"
                  style={{ borderRadius: "10px" }}
                  data-aos="fade-up"
               >
                  <span className="font-secondary">
                     There are {length} Emails
                  </span>
                  <span
                     className="cool-btn-dark py-2 px-3"
                     style={{ aspectRatio: "unset", borderRadius: "20px" }}
               ...
               {isEmpty && (
                  <div
                     ...
                     style={{ position: "absolute", right: "25%", left: "25%" }}
                  >
               ...
               {emails.map((email) => (
                  ...
                  >
                     ...
                     <div className="email-container mb-1 d-flex justify-content-start align-items-center">
                        ...
                        >
                           <p
                              className="font-secondary m-0 text-end"
                              style={{ fontSize: "12px" }}
                           >
                              {moment(email.createdAt).format("HH:mm, MMMM Do")}
                           </p>
                        </div>
                        <div
                           style={{
