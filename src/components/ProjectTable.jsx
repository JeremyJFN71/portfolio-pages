...
export default function ProjectTable({ projects }) {
   ...
   const changeEnable = async (index, id) => {
      ...
      const body = { enable: enable[index] };
         ...
         <table className="table primary">
            <thead>
               <tr className="text-center tertiary">
                  <th className="font-primary" scope="col">
                     #
                  </th>
                  <th className="font-primary" scope="col">
                     Name
                  ...
                  <tr key={project._id} className="text-center">
                     ...
                     <td>
                        <a
                           ...
                           className="underline-hover font-secondary"
                           target="_blank"
                           rel="noreferrer"
                        >
                           {project.name}
                     ...
                     <td>
                        <div className="form-switch">
                           <input
                              ...
                              role="switch"
                              defaultChecked={project.enable}
                              onChange={() => changeEnable(index, project._id)}
